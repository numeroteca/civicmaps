...
//	}
	if ( $form_errors[0] == '' ) {
		...
		wp_set_post_terms( $post_id, $project_tags, 'project-tag','True');
...
if ( is_user_logged_in() ) {
	...
	if ( $post_id != 0 ) {
		...
		echo "<p>Your project has been stored. If everything in your submit is accurate, an editor will publish your content as soon as possible.</p></section>";
