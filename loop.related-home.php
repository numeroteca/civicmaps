...
if ( get_post_type() == $general_options['pt_a'] ) {
	...
	// related tit
//	$post_tit = get_the_title();
	$post_tit = stripslashes($post->post_title);
	// related subtit
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="art-tit">
		...
		if ( get_post_type() == 'post' && isset($authorr) ) {
			echo "<span class='authoracademic'><a href='" .$post_perma. "' title='Permalink to " .$post_tit. "' rel='bookmark'>" .$post_tit. "</a> / " .$auth_inst. "</span>";
			//echo $auth_inst;
			//echo  get_the_author_meta( 'institution', $user->ID );
			//echo get_the_author_meta( 'institution', $authorr->ID );
